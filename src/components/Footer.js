...
export default function Footer() {
  return (
    <footer class="bg-footer text-white dark:bg-primary">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            ...
            <a href="#" class="text-white hover:text-primary  ms-5">
              <svg
                class="w-4 h-4"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              href="#"
              class="text-white hover:text-primary dark:hover:text-white ms-5"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
